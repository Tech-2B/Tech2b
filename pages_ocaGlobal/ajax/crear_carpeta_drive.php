...
try {
  ...
  $id_carpeta_padre = isset($_POST['id_carpeta_padre']) ? trim($_POST['id_carpeta_padre']) : null;
  ...
  // Crear la carpeta (ahora acepta carpeta padre opcional)

  if ($id_carpeta_padre && !empty($id_carpeta_padre)) {

    // Crear dentro de una carpeta específica

    $resultado = $funcionesDrive->crearCarpetaEnCualquierNivel($id_cliente, $id_plan_accion, $nombre_carpeta, $id_carpeta_padre);

  } else {

    // Crear en la carpeta raíz del plan (comportamiento anterior)
