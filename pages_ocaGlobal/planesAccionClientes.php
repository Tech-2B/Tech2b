          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form id="formulario_cargar_archivo" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="form-group navegador-carpetas-container">

                  <label class="form-label">Seleccionar Carpeta de Destino:</label>

                  <div class="navegador-carpetas-wrapper">

                    <div id="navegador_carpetas" class="navegador-carpetas">

                      <div class="text-center text-muted p-3">

                        <i class="fa fa-spinner fa-spin"></i> Cargando carpetas...
                  ...
                  <input type="hidden" id="carpeta_destino_navegador" name="carpeta_destino" value="">

                  <small class="form-text text-muted">

                    <i class="fa fa-info-circle"></i> Haz clic en una carpeta para seleccionarla. Usa el botón <i class="fa fa-plus"></i> para crear una nueva carpeta dentro de otra.
